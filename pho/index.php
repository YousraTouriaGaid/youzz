...
<div class="container">
    <div class="jumbotron text-center">
        <h2>Management of photos </h2>
    </div>
    <br>
    
    <a href="insert.php" role="button" class="btn btn-primary pull-right">Insert Photo</a>
    <br>
    <br>
...
$query = "SELECT * FROM pho ORDER BY id DESC ";
...
<?php
    ...
    if(isset($_GET['delete'])){
        ...
        $image = "SELECT * FROM pho WHERE id = $id";
        ...
        $query = "DELETE FROM pho WHERE id = $id";
