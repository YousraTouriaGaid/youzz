...
<div class="container">
    <div class="jumbotron text-center">
        <h2>Management de web design </h2>
    </div>
    <br>
    
    <a href="insert.php" role="button" class="btn btn-primary pull-right">Insert web design mr</a>
    <br>
    <br>
...
$query = "SELECT * FROM mr ORDER BY id DESC ";
...
<?php
    ...
    if(isset($_GET['delete'])){
        ...
        $image = "SELECT * FROM mr WHERE id = $id";
        ...
        $query = "DELETE FROM mr WHERE id = $id";
